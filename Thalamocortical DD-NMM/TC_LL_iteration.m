function [y_result,x_result] = TC_LL_iteration(y,x,z,z_dif,dw,dw_dif,v0,a0,e0,A,B,Nm)
...
y_result  = y + A(1:Nm,1).*y + A((Nm+1):2*Nm,1).*x + B(1:Nm,1).*e1 + B((Nm+1):2*Nm,1).*e2;
x_result  = x + A(1:Nm,2).*y + A((Nm+1):2*Nm,2).*x + B(1:Nm,2).*e1 + B((Nm+1):2*Nm,2).*e2;
